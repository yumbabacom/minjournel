...
UserSchema.pre('save', async function(next) {
    ...
    try {
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(this.password, 12);
...
async function GET(request) {
    try {
        ...
        // Find user
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(decoded.userId);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request) {
    try {
        ...
        let decoded;
        try {
            console.log('Verifying token with secret:', ("TURBOPACK compile-time truthy", 1) ? 'Secret available' : ("TURBOPACK unreachable", undefined));
            decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, JWT_SECRET);
        ...
        // Update user
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(decoded.userId, {
            $set: {
                ...updateData,
                updatedAt: new Date()
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a59e6dc._.js.map