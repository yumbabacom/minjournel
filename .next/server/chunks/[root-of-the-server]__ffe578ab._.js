...
async function GET(request) {
    try {
        ...
        const trades = await db.collection('trades').find(filter).sort({
            createdAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            trades
...
async function POST(request) {
    try {
        ...
        const { userId, accountId, accountSize, riskPerTrade, tradingPair, strategy, entryPrice, takeProfit, stopLoss, direction, status, analysis, tags, images, calculations } = body;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffe578ab._.js.map